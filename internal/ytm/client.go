...
// failures return a non-nil error. Its (name, signedIn, err) shape satisfies the
// UI's library-provider seam directly, alongside the OAuth-backed
// ytdata.Client.AccountInfo.
//
